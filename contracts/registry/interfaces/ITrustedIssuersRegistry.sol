...
interface ITrustedIssuersRegistry {
     ...
     */
    event TrustedIssuerAdded(IClaimIssuer indexed trustedIssuer, euint4[] claimTopics);
     ...
     *  `claimTopics` is the set of claims that the trusted issuer is allowed to emit
     */
    event ClaimTopicsUpdated(IClaimIssuer indexed trustedIssuer, euint4[] claimTopics);
